  ...
  return (
    <div className="flex items-end gap-2 group">
      ...
      <div className="flex items-center pb-2.5">
        <button
          type="button"
          className="p-1.5 text-muted hover:text-foreground transition-colors cursor-grab active:cursor-grabbing"
      ...
      <div className="flex-shrink-0 w-20">
        {showLabels && (
          <Label htmlFor={`qty-${ingredient.id}`} className="text-xs mb-1.5">
            Qty
          </Label>
        )}
        <Input
      ...
      <div className="flex-shrink-0 w-28">
        {showLabels && (
          <Label htmlFor={`unit-${ingredient.id}`} className="text-xs mb-1.5">
            Unit
          </Label>
        )}
        <Select
        ...
        >
          <SelectTrigger id={`unit-${ingredient.id}`} className="h-10">
      ...
      <div className="flex-1 min-w-0">
        {showLabels && (
          <Label htmlFor={`name-${ingredient.id}`} className="text-xs mb-1.5">
            Ingredient
          </Label>
        )}
        <Input
      ...
      <div className="flex-shrink-0 w-32">
        ...
        >
          <SelectTrigger id={`category-${ingredient.id}`} className="h-10">
