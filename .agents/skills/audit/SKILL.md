...
1. **Type-specific criteria**: `.Codex/skills/audit/criteria/{type}.md` (e.g., `component.md`, `page.md`, `service.md`, `structure.md`)
2. **General criteria**: `.Codex/skills/audit/criteria/general.md` (always included)
3. **Report template**: `.Codex/skills/audit/report-template.md` (always included)
...
**Manifest path**: `.Codex/last-audit.json` (project root, gitignored)
...
Use the **Write** tool to write the JSON to `.Codex/last-audit.json`. Overwrite any existing manifest — only the most recent audit matters.
