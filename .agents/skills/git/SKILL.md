...
This skill ensures consistent git practices across the codebase. It defines strict conventions for branch names, commit messages, and PR workflows that Codex should follow automatically when performing any git operations.
