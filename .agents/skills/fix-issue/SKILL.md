...
Follows `.Codex/skills/git/SKILL.md` conventions:

```
Codex/issue-<number>-<YYYYMMDD>-<HHMM>
```

Example: `Codex/issue-57-20260130-1445`
...
- Creates branch: `Codex/issue-57-20260130-1445`
...
- Creates branch: `Codex/issue-82-20260130-1500`
...
- Creates branch: `Codex/issue-91-20260130-1530`
